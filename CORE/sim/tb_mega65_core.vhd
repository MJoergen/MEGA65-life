...
begin
   ...
   mega65_core_inst : entity work.mega65_core
      ...
      port map (
         ...
         mem_clk_i                => '0',
         mem_rst_i                => '1',
         mem_core_write_o         => open,
         mem_core_read_o          => open,
         mem_core_address_o       => open,
         mem_core_writedata_o     => open,
         mem_core_byteenable_o    => open,
         mem_core_burstcount_o    => open,
         mem_core_readdata_i      => (others => '0'),
         mem_core_readdatavalid_i => '0',
         mem_core_waitrequest_i   => '0',
         mem_high_i               => '0',
         mem_low_i                => '0',
         video_clk_o              => open,
         video_rst_o              => open,
